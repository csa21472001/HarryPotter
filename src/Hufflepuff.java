public class Hufflepuff extends hogwarts {
    ...
    public static void checkWhoIsTheBetterStudentInRavenclaw(int indexOfStudent_1, int indexOfStudent_2) {
        ...
        int sumOfQualities_1 = hufflepuffs[indexOfStudent_1].getSorcery() + hufflepuffs[indexOfStudent_1].getTransgression() + hufflepuffs[indexOfStudent_1].getHardworking() + hufflepuffs[indexOfStudent_1].getHonest() + hufflepuffs[indexOfStudent_1].getLoyality();
        int sumOfQualities_2 = hufflepuffs[indexOfStudent_2].getTransgression() + hufflepuffs[indexOfStudent_2].getSorcery() + hufflepuffs[indexOfStudent_2].getHardworking() + hufflepuffs[indexOfStudent_2].getHonest() + hufflepuffs[indexOfStudent_2].getLoyality();
